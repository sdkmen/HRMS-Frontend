  ...
  return (
    <Jumbo>
      <div>
        <Title>
          <Container>
            <h1 className="text-center align-center fw-bold">Human Resources Management System</h1>
        ...
        <ButtonGroup className="mt-5">
          <Link to="/jobadverts">
            <Button className="m-3" variant="light">Job Adverts</Button>
          </Link>
          <Link to="/candidates">
            <Button className="m-3" variant="light">Candidates</Button>
          </Link>
          <Link to="/employers">
            <Button className="m-3" variant="light">Employers</Button>
          </Link>
        </ButtonGroup>
      </div>
    </Jumbo>
